    ...
    <section className='mx-auto pt-4 text-white'>
      ...
      {isEditing ? (
        <div className='mx-auto mt-2 max-w-[30rem] space-y-2'>
          <div className='flex'>
            <Input id='first-name' label='First Name' labelClassName='sr-only' placeholder='Tony' />
            <Input id='last-name' label='Last Name' labelClassName='sr-only' inputClassName='ml-4' placeholder='Jarvis' />
          </div>
        ...
        <div className='flex flex-col items-center space-y-6'>
          <h2 className='text-[2rem] font-bold leading-5'>Tony Jarvis!</h2>
